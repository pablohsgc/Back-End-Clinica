...
export default class Funcionario extends Pessoa{ //classe funcionario nao precisa de codigo
    ...
    constructor(nome:String,codigo:Number,email:String,telefone:String,cep:String,logradouro:String,bairro:String,cidade:String,estado:String,dataContrato:Date,salario:Number,senhaHash:String){
